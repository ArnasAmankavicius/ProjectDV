 ...
 */
package com.lanterna.terminal.virtual;

import com.lanterna.TerminalPosition;
import com.lanterna.TerminalSize;
import com.lanterna.TextCharacter;
...
public interface VirtualTerminal extends IOSafeTerminal {
     ...
     * not the same as the list of {@link com.lanterna.terminal.TerminalResizeListener}, but as the
     ...
     * same as the list of {@link com.lanterna.terminal.TerminalResizeListener}.
     *
